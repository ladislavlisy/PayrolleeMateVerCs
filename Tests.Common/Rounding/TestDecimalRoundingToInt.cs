...
namespace Tests.Common.Rounding
{
	...
	{
		private readonly int TEST_POS_RESULT_NUMBER_DOWN = 1000;

		private readonly int TEST_POS_RESULT_NUMBER_UP = 1001;
		...
		private readonly int TEST_NEG_RESULT_NUMBER_DOWN = -1000;

		private readonly int TEST_NEG_RESULT_NUMBER_UP = -1001;
