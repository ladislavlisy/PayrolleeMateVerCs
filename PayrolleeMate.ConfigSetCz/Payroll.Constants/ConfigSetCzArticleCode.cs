...
{
	public enum ConfigSetCzArticleCode : uint
	{
		ARTICLE_UNKNOWN = ArticleCode.ARTICLE_UNKNOWN,
		ARTICLE_CONTRACT_EMPL_TERM = ArticleCode.ARTICLE_CONTRACT_EMPL_TERM,
		ARTICLE_POSITION_TERM = ArticleCode.ARTICLE_POSITION_TERM,
		ARTICLE_INCOME_GROSS = ArticleCode.ARTICLE_INCOME_GROSS,
		ARTICLE_INCOME_NETTO = ArticleCode.ARTICLE_INCOME_NETTO,
		...
		ARTICLE_TAXING_ALLOWNACE_STUDYING = 424,
