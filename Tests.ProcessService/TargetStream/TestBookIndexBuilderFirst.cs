...
{
	[TestFixture ()]
	public class TestBookIndexBuilderFirst
	{
		uint codeOrder01 = 1;
		uint codeOrder02 = 2;
		uint codeOrder03 = 3;
		...
		[Test ()]
		public void Should_Return_First_CodeOrder_2_With_Missing_1 ()
		{
		...
		[Test ()]
		public void Should_Return_First_CodeOrder_1_With_Missing_4 ()
		{
			IBookIndex[] testArray = new IBookIndex[] {
				index01, index02, index04, index05, 
		...
		[Test ()]
		public void Should_Return_First_CodeOrder_1_From_Missing_Collection ()
		{
			IBookIndex[] testArray = new IBookIndex[] {
				index01, index02, index04, index05, 
				index21, index22, index23, index24, index26, index27, index28, index29
		...
		[Test ()]
		public void Should_Return_First_CodeOrder_1_From_Empty_Collection ()
		{
